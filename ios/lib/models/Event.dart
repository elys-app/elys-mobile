...
class Event extends Model {
  ...
  const Event._internal({required this.id, required contactEmail, required groupId, required contentId, required name, required eventDate, required eventMonth, required eventYear, description}): _contactEmail = contactEmail, _groupId = groupId, _contentId = contentId, _name = name, _eventDate = eventDate, _eventMonth = eventMonth, _eventYear = eventYear, _description = description;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'contactEmail': _contactEmail, 'groupId': _groupId, 'contentId': _contentId, 'name': _name, 'eventDate': _eventDate, 'eventMonth': _eventMonth, 'eventYear': _eventYear, 'description': _description
  };
